// components/Dashboard/AddAccount.js
...
const AddAccount = ({ isOpen, onClose, onSave }) => {
  ...
  return (
    <Transition.Root show={isOpen} as={Fragment}>
      <Dialog as="div" static className="fixed inset-0 overflow-y-auto" open={isOpen} onClose={onClose}>
                    ...
                    <div className="mt-2">
                      <div className="mb-2">
                        ...
                        <input
                          ...
                          name="service"
                          id="service"
                          className="mt-1 p-2 focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                          value={service}
